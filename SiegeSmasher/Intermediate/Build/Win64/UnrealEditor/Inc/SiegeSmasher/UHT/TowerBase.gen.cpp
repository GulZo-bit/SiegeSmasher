...
struct Z_Construct_UClass_ATowerBase_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Towers_MetaData[] = {
		{ "Category", "Towers" },
		{ "ModuleRelativePath", "Towers/TowerBase.h" },
	};
...
#endif // WITH_METADATA
	static const UECodeGen_Private::FClassPropertyParams NewProp_Towers_Inner;
	static const UECodeGen_Private::FArrayPropertyParams NewProp_Towers;
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_ATowerBase_Statics::NewProp_Towers_Inner = { "Towers", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UClass, Z_Construct_UClass_ATowerBase_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ATowerBase_Statics::NewProp_Towers = { "Towers", nullptr, (EPropertyFlags)0x0024080000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATowerBase, Towers), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Towers_MetaData), NewProp_Towers_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATowerBase_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATowerBase_Statics::NewProp_Towers_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATowerBase_Statics::NewProp_Towers,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Github_SiegeSmasher_SiegeSmasher_Source_SiegeSmasher_Towers_TowerBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATowerBase, ATowerBase::StaticClass, TEXT("ATowerBase"), &Z_Registration_Info_UClass_ATowerBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATowerBase), 1915903653U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Github_SiegeSmasher_SiegeSmasher_Source_SiegeSmasher_Towers_TowerBase_h_3642975349(TEXT("/Script/SiegeSmasher"),
	Z_CompiledInDeferFile_FID_Github_SiegeSmasher_SiegeSmasher_Source_SiegeSmasher_Towers_TowerBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Github_SiegeSmasher_SiegeSmasher_Source_SiegeSmasher_Towers_TowerBase_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
